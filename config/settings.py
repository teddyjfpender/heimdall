...
class StarknetConfig:
    ...
    node_url: str = os.getenv('STARKNET_NODE_URL', 'https://starknet-goerli.public.blastapi.io')
...
class SecurityConfig:
    ...
    require_attestation: bool = os.getenv('REQUIRE_ATTESTATION', 'false').lower() == 'true'
    ...
    def validate(self) -> List[str]:
        ...
        if self.is_production:
            ...
            if self.aws.endpoint_url and 'localhost' in self.aws.endpoint_url:
                errors.append("AWS_ENDPOINT_URL should not point to localhost in production")
