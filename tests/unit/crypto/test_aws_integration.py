...
class TestKMSDecryption:
    ...
    def test_kms_decrypt_master_seed_success(self):
        ...
        with patch('aws_multiuser_integration.subprocess.Popen') as mock_popen:
            # Setup mock process
            mock_process = Mock()
    ...
    def test_kms_decrypt_master_seed_invalid_output_format(self):
        ...
        with patch('aws_multiuser_integration.subprocess.Popen') as mock_popen:
            ...
            # Should raise KMSDecryptionError
            with pytest.raises(KMSDecryptionError, match="Unexpected KMS output format"):
                kms_decrypt_master_seed(credential, ciphertext)
...
class TestStarknetMultiUserAWSManager:
    ...
    def test_load_master_seed_success(self, aws_manager, mock_master_seed):
        ...
        with patch('aws_multiuser_integration.kms_decrypt_master_seed') as mock_decrypt:
    ...
    def test_derive_user_key_with_validation_success(self, aws_manager, mock_master_seed):
    ...
    def test_derive_user_key_with_validation_invalid_session(self, aws_manager, mock_master_seed):
    ...
    def test_process_user_transaction_request_success(self, aws_manager, mock_master_seed):
    ...
    def test_process_user_transaction_request_missing_fields(self, aws_manager, mock_master_seed):
...
class TestUtilityFunctions:
    ...
    def test_extract_user_context_from_request(self):
        ...
        username, key_index, session_data = extract_user_context_from_request(request_payload)
