...
class TestUserKeyDerivation(unittest.TestCase):
    ...
    def test_key_derivation_performance(self):
        ...
        print(f"100 key derivations took {duration:.2f} seconds ({100/duration:.1f} keys/sec)")
...
class TestUserIsolation(unittest.TestCase):
    ...
    def test_timing_attack_resistance(self):
        ...
        self.assertLess(ratio, 1.5, "Timing difference suggests vulnerability to timing attacks")
...
class TestSecurityProperties(unittest.TestCase):
    ...
    def test_username_case_sensitivity(self):
        ...
        manager = StarknetMultiUserKeyManager(create_test_master_seed(deterministic=True))
